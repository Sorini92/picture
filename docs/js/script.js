...
var calc = function calc(size, material, options, promocode, result) {
  ...
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["getResource"])('assets/db.json').then(function (res) {
  ...
  function createMaterials(response) {
    response.forEach(function (_ref2) {
      var material = _ref2.material,
          materialValue = _ref2.materialValue,
          materialTitle = _ref2.materialTitle;
      var option = document.createElement('option');
      option.setAttribute('value', materialValue);
      option.setAttribute('title', materialTitle);
      option.innerHTML = "".concat(material);
  ...
  function createOptions(response) {
    response.forEach(function (_ref3) {
      var extra = _ref3.extra,
          extraValue = _ref3.extraValue;
      var option = document.createElement('option');
      option.setAttribute('value', extraValue);
      option.innerHTML = "".concat(extra);
  ...
  blocks.forEach(function (block) {
    block.addEventListener('mouseover', function () {
      ...
      img.forEach(function (item) {
        return item.setAttribute('src', src);
      });
    ...
    block.addEventListener('mouseout', function () {
      var p = block.querySelectorAll('.size, .starting-price, .final-price'),
          img = block.querySelectorAll(imgSelector);
      img.forEach(function (item) {
        return item.setAttribute('src', defaultSrc);
      });
      p.forEach(function (item) {
...
var filter = function filter() {
  ...
  function menuButtons(btn, mark) {
    menu.querySelector(btn).addEventListener('click', function () {
      typeFilter(mark);
    });
  }
...
/* harmony import */ var core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_5__);
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_13__["postData"])(api, formData).then(function (res) {
        console.log(res);
